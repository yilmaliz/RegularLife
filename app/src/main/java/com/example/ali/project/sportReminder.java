...
public class sportReminder extends Service {
    android.support.v4.app.NotificationCompat.Builder notification;
    private static final int uniqueID=  8;
    ...
    public void setNotification(){
        ...
        notification.setContentTitle("Reular Life");
        notification.setContentText("Do Sport!");

        Intent noti = new Intent(this,sportReminder.class);
