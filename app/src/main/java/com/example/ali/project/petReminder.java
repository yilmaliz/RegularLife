...
public class petReminder extends Service {
    ...
    public void setNotification(){
        ...
        notification.setContentText("Take Care of Your Pet!");

        Intent noti = new Intent(this,petReminder.class);
