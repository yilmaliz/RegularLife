...
public class callReminder extends Service {
    ...
    public void setNotification(){
        ...
        notification.setContentText("Call someone you have to call");

        Intent noti = new Intent(this,callReminder.class);
